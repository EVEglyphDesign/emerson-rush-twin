...
def cover_flow():
    return [
        Spacer(1, 30),
        Paragraph(f'<font name="Fraunces" size="9" color="#e87722">EVEGLYPHDESIGN · MIRROR 4 · {DOC_ID}</font>',
                  S("k", fontSize=9, spaceAfter=6, textColor=ORNG)),
        Paragraph(TITLE, S("t", fontName="Fraunces-Bold", fontSize=42, leading=48, spaceAfter=6)),
        Paragraph("Transformational program management for information &amp; technology",
        ...
        AccentRule(),
        Paragraph('<font name="Inter-Bold">For this reader.</font> This mirror of the handbook is prepared for a Group Platforms conversation '
        ...
        Paragraph(f'<font name="Inter-SB">Key ID</font>  {KEY_ID}  ·  <font name="Inter-SB">Companion</font>  '
                  f'Mirror-3 Lillian&rsquo;s Guide (peer-review canon)', st_cap),
    ]
